...
#     print(oDataSet)
# oExp.save("OBJECTS/EXP_01_ACC_M{}-{}_{}_CM8b.txt".format(MIN_DECIMATION,MAX_DECIMATION,NUMBER_OF_ROUNDS))

######################

oExp = oExp.load("OBJECTS/EXP_01_ACC_M{}-{}_{}_CM8b.txt".format(MIN_DECIMATION, MAX_DECIMATION, NUMBER_OF_ROUNDS))
