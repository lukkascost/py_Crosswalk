...
#     oDataSet = DataSet()
#     base = np.loadtxt(PATH_TO_SAVE_FEATURES + "FEATURES_M1_CM{}b_TH198.txt".format(n_bits), usecols=basemask, delimiter=",")
#     classes = np.loadtxt(PATH_TO_SAVE_FEATURES + "FEATURES_M1_CM{}b_TH198.txt".format(n_bits), dtype=object, usecols=24, delimiter=",")
...
#     oExp.add_data_set(oDataSet, description="  50 execucoes M=1 CM={}b base CROSSWALK arquivos em EXP_04".format(n_bits))
#     print(oDataSet)
# oExp.save("OBJECTS/EXP_04_ACC_M1_50_CM2-8b.txt")

######################

oExp = oExp.load("OBJECTS/EXP_04_ACC_M1_50_CM2-8b.txt")
