...
#     oExp.addDataSet(oDataSet, description="  50 execucoes M=1 CM={}b base CROSSWALK arquivos em EXP_01".format(n_bits))
#     print(oDataSet)
# oExp.save("OBJECTS/EXP_01_ACC_M1_50_CM2-8b.txt")

######################

oExp = oExp.load("OBJECTS/EXP_01_ACC_M1_50_CM2-8b.txt")
print oExp